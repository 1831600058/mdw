...
from log_mel import log_mel_spectrogram_custom
...
class test_dataset(torch.utils.data.Dataset):
    def __init__(self, root_path, test_name, name_list):
        ...
        for i in tqdm(range(len(self.test_files))):
            ...
            y_specgram = file_to_log_mel_spectrogram(y, sr, n_fft=1024, hop_length=512, n_mels=128, power=2)
            #y_specgram = log_mel_spectrogram_custom(y, sr,  n_mels=128,n_fft=1024, hop_length=512, power=2)
